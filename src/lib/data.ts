...
export async function getSiteSettings() {
  ...
  return {
    ...
    weatherMode: values.weatherMode === "manual" ? "manual" : "auto",
    manualWeatherCondition: values.manualWeatherCondition ?? "晴天",
    manualWeatherTemperature: values.manualWeatherTemperature ?? "",
    manualWeatherDescription: values.manualWeatherDescription ?? "",
