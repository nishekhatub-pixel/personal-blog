...
export async function updateSettings(
  ...
  const parsed = siteSettingsSchema.safeParse({
    ...
    weatherMode: stringValue(formData, "weatherMode") || "auto",
    manualWeatherCondition: stringValue(formData, "manualWeatherCondition"),
    manualWeatherTemperature: stringValue(formData, "manualWeatherTemperature"),
    manualWeatherDescription: stringValue(formData, "manualWeatherDescription"),
  ...
  if (!parsed.success) {
    ...
    const fieldLabels: Record<string, string> = {
      ...
      latitude: "纬度",
      longitude: "经度",
      manualWeatherCondition: "手动天气状态",
      manualWeatherDescription: "手动天气描述",
      manualWeatherTemperature: "手动温度",
  ...
  const groups: Record<string, string> = {
    ...
    manualWeatherCondition: "location",
